...
**Using SELECT \* FROM SOME\_EXISTING\_TABLE Error Based**
...
#### Extract database with information\_schema
...
#### Extract columns name without information\_schema
...
* group\_concat\(\) = 1024 symbols
* json\_arrayagg\(\) &gt; 16,000,000 symbols
...
* [ekoparty web\_100 - 2016/10/26 - p4-team](https://github.com/p4-team/ctf/tree/master/2016-10-26-ekoparty/web_100)
